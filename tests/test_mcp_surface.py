...
#
# The 5 named above account for 5 of these 19; the rest (crop_spec, cross_cut,
# fetch_image, filmstrip, generate_captions, jump_cut, montage,
...
EXPECTED_HTTP_ONLY = frozenset({
    ...
    "lyrics_sync", "montage", "normalize_window", "proxy", "search_images",
    "search_news", "stem_separation", "virtual_to_original", "waveform_image",
    "waveform_peaks",
})
